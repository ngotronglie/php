<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Danh sách Dăng kí lớp <span class=" badge badge-success text-light font-bold">đã</span> duyệt</h5>
                    <div class="table-responsive">
                        <table id="zero_config" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <?php foreach($danhsach_duyetlop_daduyet as $key => $value):?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $value['price_khoahoc']?></td>
